    ...
    <div className='fixed top-0 bottom-0 left-0 right-0 z-110 h-screen overflow-y-scroll bg-black/50'>
      <div className='max-w-2xl sm:py-6 mx-auto'>
        <div className='bg-white rounded-lg shadow p-6'>
          <h1 className='text-2xl font-bold txt-gray-900 mb-6'>Edit Profile</h1>
          ...
          <form className="space-y-4" onSubmit={handleSaveProfile} action="">
            ...
            <div>
              ...
              <div className='group/porfile relative'>
                <img src={editForm.profile_picture ? URL.createObjectURL(editForm.profile_picture) : user.profile_picture}
                  className="w-24 h-24 rounded-full object-cover mt-2" alt="" />

                <div className='absolute hidden group-hover/profile:flex top-0 left-0 bottom-0 bg-black/20 rounded-full item-center justify-center'>
            ...
            <div className='flex flex-col items-start gap-3'>
              <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                ...
                <div className='group/cover relative'>
                  ...
                  <div className='absolute hidden group-hover/cover:flex top-0 left-0 bottom-0 bg-black/20 rounded-full item-center justify-center'>
                    <Pencil className='w-5 h-5 text-white' />
                  </div>
                </div>
              </label>
            ...
            <div>
              <label className='block text-sm font-medium text-gray-700 mb-1'>
                ...
                <input type="text" placeholder='Please enter your full name'
                  className='w-full p-3  border borderr-gray-200 rounded-lg'
                  onChange={(e) => setEditForm({ ...editForm, full_name: e.target.files[0] })} value={editForm.full_name} />
              </label>
            </div>
            ...
            <div>
              <label className='block text-sm font-medium text-gray-700 mb-1'>
                ...
                <input type="text" placeholder='Please enter your username'
                  className='w-full p-3  border borderr-gray-200 rounded-lg'
                  onChange={(e) => setEditForm({ ...editForm, username: e.target.files[0] })} value={editForm.username} />
              </label>
            </div>
            ...
            <div>
              <label className='block text-sm font-medium text-gray-700 mb-1'>
                Bio
                <textarea rows={3} type="text" placeholder='Add your bio...'
                  className='w-full p-3  border borderr-gray-200 rounded-lg'
                  onChange={(e) => setEditForm({ ...editForm, bio: e.target.files[0] })} value={editForm.bio} />
              </label>
            </div>
            ...
            <div>
              <label className='block text-sm font-medium text-gray-700 mb-1'>
                ...
                <input type="text" placeholder='Please enter your location'
                  className='w-full p-3  border borderr-gray-200 rounded-lg'
                  onChange={(e) => setEditForm({ ...editForm, location: e.target.files[0] })} value={editForm.location} />
              </label>
            </div>
