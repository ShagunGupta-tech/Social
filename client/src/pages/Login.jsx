  ...
  return (
    <div className='min-h-screen flex flex-col  md:flex-row'>
      ...
      <div className='flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40'>
        <img src={assets.logo} alt="" className='h-12 object-cover' />
        <div>
          <div className='flex items-center gap-3 mb-4 max-md:mb-10'>
          ...
          <h1 className='text-3xl md:text-6xl md:pb-2 font-bold bg-gradient-to-r
           from-indigo-950  to-indigo-800 bg-clip-text text-transparent'>
            More than just friend truly connect</h1>
            <p className='text-xl md:text-3xl text-indigo-800 max-w-72 
            md:max-w-md'>connect with global community on soical.</p>
        </div>
