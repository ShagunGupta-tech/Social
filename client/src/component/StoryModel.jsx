            ...
            <div className='w-full max-w-md'>
                ...
                <div className='text-center mb-4 flex  items-center justify-between'>
                    <button onClick={() => setShowModal(false)} className='text-white p-2 cursor-pointer'>
                        <ArrowLeft />
                        <h2 className='flex text-lg font-semibold'>Create Story</h2>
              ...
              relative' style={{ backgroundColor: background }}>
                    {
                        mode === 'text' && (
                         ...
                         text-lg  resize-none  focus:outline-none'
                ...
                <div className='flex gap-2 mt-4 '>
                    <button
                        ...
                        className={`flex flex-1 items-center justify-center gap-2 p-2 rounded-2xl cursor-pointer *:
                        ${mode === 'text' ? 'bg-white text-black' : 'bg-zinc-800'}
                        `}>
                        <TextIcon size={18} />Text
                    </button>
                    <label className={`flex flex-1 items-center justify-center gap-2 p-2 rounded-2xl cursor-pointer
                ...
                onClick={()=>toast.promise(handleCreateStory(),{
                 ...
                 className=' flex items-center justify-center gap-2 text-white
                     py-3 mt-4 rounded w-full 
                     cursor-pointer transition bg-gradient-to-r from-indigo-500 to-purple-600
                     hover:from-indigo-600 hover:to-purple-700 actove:scale-95'>
