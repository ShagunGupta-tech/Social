...
const PostCard = ({post}) => {
  ...
  return (
    <div className='bg-white rounded-xl shadow p-4 space-x-4 w-full max-w-2xl'>
       {/* User Info  */}
       <div  onClick={()=>navigate('/profile/' + post.user._id)} className='inline-flex items-center gap-3 cursor-pointer'>
         ...
         <div>
            ...
            <div className='text-gray-500 text-sm'>@{post.user.username}▫️{ moment(post.createdAt).fromNow()}</div>
         </div>
       </div>
